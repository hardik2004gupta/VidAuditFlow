...
function Button({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      // Every `render` usage in this codebase polymorphs into a non-<button>
      // element (Link, etc.), so default nativeButton to false whenever
      // `render` is passed -- callers can still override explicitly.
